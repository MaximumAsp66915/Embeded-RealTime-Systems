...
detector} (\texttt{cv2.HOGDescriptor\_getDefaultPeopleDetector()}). This
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{../../2.Image Processing/results/fig-gitignore/320p_1_1_low-light.png}
...
\caption{A strongly backlit frame in which the subject is reduced to a silhouette; the detector nonetheless produced a (loosely aligned) bounding box, illustrating both the difficulty of this condition and the detector's partial robustness to it.}\label{fig:back-light-hit}
\end{figure}
...
memory use and a modest FPS penalty.
